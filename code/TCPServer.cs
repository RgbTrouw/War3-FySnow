...
public class TCPServer : MonoBehaviour
{
    ...
    private gamePlay gamePlayData = new gamePlay();
    ...
    [SerializeField] public GameObject startGameObjects, serverPanel, characterSelectionPanel;
        ...
        try
        {
            while ((bytesRead = stream.Read(buffer, 0, buffer.Length)) > 0)
            {
                ...
                if(message.Split(' ')[0] == "setName"){
                    ...
                    response = Encoding.UTF8.GetBytes("initializeGame");
                }
