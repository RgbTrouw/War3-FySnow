                        ...
                        /// 
                            ...
                            if(serverMessage.Split(' ')[0] == "0"){
                                 ...
                                 if(serverMessage.Split(' ')[1] == "join"){
                                        ...
                                        if(serverMessage.Split('\n')[0].Split(' ')[1] == "mouse"){

                                            
                                            UnityMainThreadDispatcher.Enqueue(() =>
                                            {
                                                player.transform.Rotate(new Vector3(0, float.Parse(serverMessage.Split('\n')[0].Split(' ')[2]) *2,0));
                                                playerCamera.transform.Rotate(new Vector3(-float.Parse(serverMessage.Split('\n')[0].Split(' ')[3]) *2,0,0));

                                            });

                                        } 
                                        
                                        else if(serverMessage.Split('\n')[0].Split(' ')[1] == "gravity"){
                                        ...
                                        } else if(serverMessage.Split('\n')[0].Split(' ')[1] == "idle" && gameHost.playersList[0].charLoaded == true) {
